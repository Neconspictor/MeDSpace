...
\include{data-integration/data-integration}

%\include{summaries/summaries}
\include{summaries/TowardsAModelToDataspaces_NDJAFA}
\include{summaries/DatabasesToDataspacesANewAbstractionForInformationManagement}
\include{summaries/PrinciplesOfDataspaceSystems}
\include{summaries/TowardsRealizationOfDataspaces}
\include{summaries/DebugITOntologyMediatedLayeredDataIntegration}
\include{summaries/DataModelingInDataspaceSupportSystems}
