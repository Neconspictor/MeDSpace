...
In this section we will talk about implementation details of the SQL wrapper. For the SQL wrapper we used a MySQL database as the relational datasource the wrapper should proxy. So, at first we want to look at how this type of datasource is setup properly.
