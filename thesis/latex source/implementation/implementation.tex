...
To support UTF-8 add the following settings to your my.cnf (or my.ini)\footnote{More informations about option files: \url{https://dev.mysql.com/doc/refman/5.7/en/option-files.html}}
