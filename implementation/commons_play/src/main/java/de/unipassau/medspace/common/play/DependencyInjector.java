...
public class DependencyInjector extends AbstractModule {
   ...
   */
  @Inject
  public DependencyInjector(Environment environment, Configuration configuration) {
    super();
  ...
  protected void configure() {
    ...
    bind(ProjectResourceManager.class).asEagerSingleton();

    bind(PathResolveParser.class)
        .toProvider(ProjectResourceManager.class).asEagerSingleton();
