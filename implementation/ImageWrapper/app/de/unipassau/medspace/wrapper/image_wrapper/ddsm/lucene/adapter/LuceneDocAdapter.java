...
import de.unipassau.medspace.wrapper.image_wrapper.config.parsing.ClassParsing;
import de.unipassau.medspace.wrapper.image_wrapper.config.parsing.Property;
import de.unipassau.medspace.wrapper.image_wrapper.ddsm.DocumentAdapter;
...
public abstract class LuceneDocAdapter<ClassType extends Identifiable>
   ...
   * TODO
   */
  protected List<Pair<String, Property>> fieldNamePropertyPairs;
   ...
   * TODO
   */
  protected LuceneDocAdapter(
                            ClassParsing classParsing) {
   ...
   * @return
   */
  public List<Pair<String, Property>>getFieldNamePropertyPairs() {
   ...
   * @param property
   */
  protected void addPair(String fieldName, Property property) {
   ...
   * @return
   */
  public abstract String createValue(Pair<String, Property> pair, IndexableField field);
}