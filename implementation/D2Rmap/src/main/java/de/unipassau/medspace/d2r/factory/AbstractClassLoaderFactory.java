 ...
 *
 */
package de.unipassau.medspace.d2r.factory;
 ...
 *
 */
public class AbstractClassLoaderFactory
   ...
   * (If found).
   *
   * @param className The name of the class to get an instance from
   * @throws FactoryException Thrown if no instance could be created
   * @return Object
   */
